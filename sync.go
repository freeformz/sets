...
// SyncMapSets is a set implementation using the built in sync.Map type. Instances of this type are safe to be used
...
// NewSync returns an empty SyncMapSets instance.
...
// NewSyncFrom returns a new SyncMapSets instance filled with the values from the sequence.
